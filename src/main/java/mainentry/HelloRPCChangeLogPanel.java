 ...
 */
public class HelloRPCChangeLogPanel extends javax.swing.JPanel {

    private Class<?> clazz;

    /** Creates new form ChangeLogPanel */
    public HelloRPCChangeLogPanel(Class<?> clazz) {
        this.clazz = clazz;
        initComponents();
        initTable();
    }
    ...
    public DefaultTableModel getTableModel() {
        ...
        HelloRPCComments commentsAnnotation = clazz.getAnnotation(HelloRPCComments.class);
        if (commentsAnnotation != null) {
            HelloRPCCommentItem[] commentItems = commentsAnnotation.value();
            if (commentItems != null) {
                for (HelloRPCCommentItem item : commentItems) {
